        ...
        <div className='grid grid-cols-2 gap-x-[12rem] gap-y-[8rem] tablet:grid-cols-3 tablet:gap-[20rem]'>
          ...
          >
            ...
            <div className='mb-[16rem] flex items-start font-poppins text-[40rem] font-semibold leading-none text-white tablet:text-[80rem] wide:text-[120rem]'>
              <span>1</span>
              <span className='text-[24rem] tablet:text-[48rem] wide:text-[72rem]'>{t('dreamUniversity.firstEnding')}</span>
            </div>
            <div className='text-[16rem] font-medium leading-tight text-white/80 tablet:text-[24rem] wide:text-[32rem]'>
              {t.rich('dreamUniversity.firstCompany', {
                br: () => <br />,
              })}
            </div>
          </figure>
          ...
          >
            ...
            />
            <div className='mb-[16rem] flex items-start font-poppins text-[40rem] font-semibold leading-none text-white tablet:text-[80rem] wide:text-[120rem]'>7.5</div>
            <div className='text-[16rem] font-medium leading-tight text-white/80 tablet:text-[24rem] wide:text-[32rem]'>
              {t.rich('dreamUniversity.averageFinalScore', {
                br: () => <br />,
              })}
            </div>
          </figure>
          ...
          >
            ...
            <div className='text-[16rem] font-medium leading-tight text-white/80 tablet:text-[24rem] wide:text-[32rem]'>{t('dreamUniversity.approvalRate')}</div>
          </figure>
          {/* // * reviews */}
          <div
