                ...
                {hasPassage && (
                  ...
                  >
                    <span className="flex size-[36rem] items-center justify-center rounded-[10rem] bg-d-yellow-secondary/70">
                      <BookOpen className="size-[18rem] text-[#6F6335]" />
                    </span>
                    <div className="flex flex-col gap-[2rem]">
                      <span className="text-[14rem] font-semibold text-d-black">View Passage</span>
                      <span className="text-[12rem] text-d-black/60">Read the full reading passage for this part</span>
                    </div>
                  </button>
                )}
