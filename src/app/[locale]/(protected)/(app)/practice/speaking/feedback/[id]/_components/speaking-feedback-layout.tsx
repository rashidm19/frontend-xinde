...
import { OverallBandCard } from '@/app/[locale]/(protected)/(app)/practice/writing/feedback/[id]/_components/overall-band-card';
import { StickySectionNav } from '@/app/[locale]/(protected)/(app)/practice/writing/feedback/[id]/_components/sticky-section-nav';
import { BackToTopButton } from '@/app/[locale]/(protected)/(app)/practice/writing/feedback/[id]/_components/back-to-top-button';
...
import { FeedbackSummaryGrid } from '@/app/[locale]/(protected)/(app)/practice/writing/feedback/[id]/_components/feedback-summary-grid';
import { CriterionTabs } from '@/app/[locale]/(protected)/(app)/practice/writing/feedback/[id]/_components/criterion-tabs';
import { UserResponseCard } from '@/app/[locale]/(protected)/(app)/practice/writing/feedback/[id]/_components/user-response-card';
  ...
  return (
    <div className='relative min-h-[100dvh] bg-[#EAF7FF]'>
      <div className='hidden tablet:block'>
        <WritingFeedbackHeader title='Speaking Feedback' exitHref='/dashboard' showFullscreen />
      </div>
      <MobileHeader title='Speaking Practice' tag='Feedback' exitLabel='Exit' closeAs='link' closeHref='/dashboard' variant='writing' />
