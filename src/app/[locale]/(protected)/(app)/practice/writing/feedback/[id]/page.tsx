...
import { WritingFeedbackLayout } from './_components/writing-feedback-layout';
import { WritingFeedbackSkeleton } from './_components/writing-feedback-skeleton';
...
export default function Page({ params }: { params: { id: string } }) {
  ...
  if (feedbackStatus === 'pending' || !feedbackData) {
    return <WritingFeedbackSkeleton />;
  }
  ...
  return <WritingFeedbackLayout data={normalized} />;
}
