...
import { PracticeBySections } from '@/app/[locale]/(protected)/(app)/dashboard/_components/PracticeList';
...
import { ProfileEditFormModal } from '@/app/[locale]/(protected)/(app)/dashboard/settings/_components/ProfileEditFormModal';
import { ChangeLangModal } from '@/app/[locale]/(protected)/(app)/dashboard/settings/_components/ChangeLangModal';
