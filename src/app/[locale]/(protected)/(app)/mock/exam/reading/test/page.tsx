...
import { DndMatching } from '@/app/[locale]/(protected)/(app)/practice/reading/test/components/DndMatching';
import { DndText } from '@/app/[locale]/(protected)/(app)/practice/reading/test/components/DndText';
...
function Page() {
  ...
  return (
    <>
      <HeaderDuringTest title='Mock exam' tag='Reading' />
