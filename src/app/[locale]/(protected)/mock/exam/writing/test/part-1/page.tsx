...
export default function Page() {
  ...
  const data = mockData?.writing?.part_1;

  async function onSubmit(values: z.infer<typeof formSchema>) {
    nProgress.start();
    void router.push('/mock/exam/writing/test/part-2');
  }
  ...
  if (!data) {
    return (
      <MissingDataFallback
        ...
        description='We could not load Writing Task 1. Please return to the mock dashboard and try again.'
          ...
          <div className='w-[672rem] rounded-[16rem] bg-white p-[40rem]'>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                >
                  Submit part 1 ( you can&apos;t go back )
                </button>
              </form>
            </Form>
          </div>
