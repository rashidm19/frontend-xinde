...
type ListeningTestClientProps = {
  practiceId: string;
};

function ListeningTestClient({ practiceId }: ListeningTestClientProps) {
  ...
  const { data, status } = useQuery({
    queryKey: ['practice-listening', practiceId],
    queryFn: () => GET_practice_listening_id(practiceId),
  });
...
const HydratedListeningTest = withHydrationGuard(ListeningTestClient);

export default HydratedListeningTest;
