  ...
  return (
    <div className='relative flex w-full items-center justify-between rounded-[999rem] bg-d-yellow-secondary/70 p-[4rem] tablet:w-fit tablet:gap-[4rem]'>
      <motion.span
        ...
        className='absolute bottom-[4rem] left-[4rem] top-[4rem] w-[calc(25%-3rem)] rounded-[999rem] bg-white shadow-[0_6rem_18rem_rgba(0,0,0,0.08)]'
      />
      {PARTS.map(part => (
        <button
          key={part.key}
          ...
          className={cn(
            'relative z-[1] flex flex-1 items-center justify-center gap-[4rem] whitespace-nowrap rounded-[999rem] px-[8rem] py-[10rem] text-[12rem] font-semibold transition tablet:gap-[6rem] tablet:px-[16rem] tablet:text-[13rem]',
