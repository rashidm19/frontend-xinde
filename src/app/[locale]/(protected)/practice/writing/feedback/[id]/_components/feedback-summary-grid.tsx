  ...
  return (
    <section className='space-y-[16rem] tablet:space-y-[20rem]'>
      <header className='space-y-[6rem] tablet:space-y-[8rem]'>
        ...
        <h2 className='text-[19rem] font-semibold text-slate-900 tablet:text-[28rem]'>Feedback summary</h2>
      </header>
      <div className={`grid gap-[12rem] tablet:grid-cols-${criteria.length} tablet:gap-[18rem]`}>
          ...
          return (
            ...
            >
              <div className='flex items-center justify-between gap-[12rem]'>
                ...
                <span
                  className={`rounded-full px-[12rem] py-[6rem] text-[13rem] font-semibold ${badge.bg} ${badge.text} ${badge.border} tablet:px-[14rem] tablet:text-[14rem]`}
                >
