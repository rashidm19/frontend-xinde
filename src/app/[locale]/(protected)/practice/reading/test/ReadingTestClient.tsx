...
function ReadingTestClient({ practiceId }: ReadingTestClientProps) {
...
const HydratedReadingTest = withHydrationGuard(ReadingTestClient);

export default HydratedReadingTest;
