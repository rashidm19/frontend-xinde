          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            >
              ...
              <div className="mb-[40rem] flex items-start justify-between">
                {/* // * Навигация по частям */}
                <TabsList
                  className="practice-tabs-shadow relative flex w-fit items-center gap-x-[8rem] rounded-[64rem] bg-white p-[8rem] text-[14rem] font-medium leading-[26rem] tracking-[-0.2rem] text-d-black">
                  <TabsTrigger
                    value="p1"
              ...
              {/* // * Инструкция */}
              <div
                className="relative mb-[40rem] flex w-full items-center justify-center rounded-[13rem] bg-white py-[24rem] text-[20rem] font-medium leading-[24rem] tracking-[-0.2rem] text-d-black">
                ...
                >
                  ...
                  {data[`part_${tab}`].blocks.map((block: any, index: number) => (
                    <div key={`questions-block-${index}`}>
                      <div
                        className="mb-[40rem] flex flex-col items-center justify-center rounded-[13rem] bg-d-gray p-[20rem]">
                        <p
                          className="mb-[8rem] text-[20rem] font-bold leading-[24rem] tracking-[-0.2rem] text-d-black">{block.task_questions} </p>
                        <p
                          className="text-[16rem] font-medium leading-[19rem] text-[listening_0606060]">{block.task}</p>
                      </div>
                      {/* A,B,C,D тесты */}
                      {block.kind === 'test' && (
                        <div className="flex flex-col gap-y-[48rem]">
                          {block.questions.map((q: any) => (
                            <div key={`listening_${q.number}`}>
                              <div
                                className="mb-[24rem] flex items-start gap-x-[24rem] text-[20rem] font-medium leading-[24rem] tracking-[-0.2rem] text-d-black">
                      ...
                      {block.kind === 'checkboxes' && (
                        <div className="flex flex-col items-start">
                          {block.text &&
                            <div className="mb-[12rem] text-[20rem] font-medium text-d-black">{block.text}</div>}
                      ...
                      {block.kind === 'unexisting' && (
                        <div className="flex w-full flex-col rounded-[16rem] bg-white p-[40rem]">
                          <div
                            className="mb-[40rem] flex flex-col items-center justify-center rounded-[13rem] bg-d-gray p-[20rem]">
                            <p
                              className="mb-[8rem] text-[20rem] font-bold leading-[24rem] tracking-[-0.2rem] text-d-black">Questions
                              1-10 </p>
                            <p className="text-[16rem] font-medium leading-[19rem] text-[listening_0606060]">
                              Complete the notes. Write <span className="font-semibold uppercase text-d-black">ONE WORD AND/OR A NUMBER</span> for
                              each answer.
                            </p>
                          </div>

                          <div
                            className="mb-[32rem] flex items-start gap-x-[32rem] text-[20rem] font-medium leading-[24rem] tracking-[-0.2rem] text-d-black">
                            Phone call about second-hand furniture
                          </div>
                          <div
                            className="mb-[24rem] flex items-start gap-x-[32rem] text-[20rem] font-medium leading-[24rem] tracking-[-0.2rem] text-d-black">Items
                          </div>
                          ...
                          <div className="mb-[34rem] flex w-full items-start">
                            ...
                            <div
                              className="mt-[4rem] w-[200rem] text-[16rem] font-medium leading-[19rem] tracking-[-0.2rem] text-d-black/80">Dining
                              table:
                            </div>
                            <div className="w-full">
                              {/* // * Ответы */}
                              <ul
                                className="flex list-outside list-none flex-col items-start justify-start gap-y-[24rem]">
                                <li id="listening_01"
                                    className="scroll-target text-[16rem] font-normal leading-[19rem] tracking-[-0.2rem] text-d-black/80">
                                  -{' '}
                                  <Input
                                    type="text"
                                    placeholder="1"
                          ...
                          <div className="mb-[34rem] flex w-full items-start">
                            {/* // * Тема */}
                            <div
                              className="mt-[4rem] w-[200rem] text-[16rem] font-medium leading-[19rem] tracking-[-0.2rem] text-d-black/80">Desk:
                            </div>
                            <div className="w-full">
                              {/* // * Ответы */}
                              <ul
                          ...
                          <div className="mb-[34rem] flex w-full items-start">
                            {/* // * Тема */}
                            <div
                              className="mt-[4rem] flex w-[200rem] text-[20rem] font-medium leading-[24rem] tracking-[-0.2rem] text-d-black">Address:
                            </div>
                            <div className="w-full">
                              {/* // * Ответы */}
                              <ul
                          ...
                          <div className="mb-[34rem] flex w-full items-start">
                            {/* // * Тема */}
                            <div
                              className="mt-[4rem] flex w-[200rem] text-[20rem] font-medium leading-[24rem] tracking-[-0.2rem] text-d-black">Directions:
                            </div>
                            <div className="w-full">
                              {/* // * Ответы */}
                              <ul
                                ...
                                <li
                                  className="scroll-target text-[16rem] font-normal leading-[19rem] tracking-[-0.2rem] text-d-black/80">
                                  - Take the Hawcroft road out of Stonethorpe. Go past the secondary school, then
                                  turn{' '}
                                  <Input
                                    id="listening_09"
                                    type="text"
